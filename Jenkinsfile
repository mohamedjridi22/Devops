    ...
    stages {
	   ...
	   steps {
		 ...
		 script {
			// Generating image from Dockerfile
			  sh 'docker build -t fatmabenabdelaziz/gestion-station-ski-1.0.jar .'
			}
		 }
	    }
	   ...
	   steps {
		 ...
		 script {
                    ...
                    // Push Docker image
                           sh 'docker push fatmabenabdelaziz/gestion-station-ski-1.0.jar'
                }
	   	 }
	     } 
		...
		steps {
			mail bcc: '', body: '" Build Successfully "', cc: '', from: '', replyTo: '', subject: 'Jenkins Notifications', to: 'fatma.benabdelaziz@esprit.tn'
		}
